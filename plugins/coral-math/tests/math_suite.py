...
#: worth having — `math` is what the DealiiX platform's `-p` contract names.
PLUGIN_NAME = "math"
...
#: The graphs this plugin owns — real editor exports plus the collection/math interop graph.
