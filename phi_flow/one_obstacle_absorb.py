...
animSmoke.save('obstacle_with_vent.gif')
animSmoke.save('obstacle_with_vent.mp4', writer='ffmpeg', fps=15, dpi=150)
animPressure.save('obstacle_with_vent_pressure.mp4', writer='ffmpeg', fps=15, dpi=150)
animVelocity.save('obstacle_with_vent_velocity.mp4', writer='ffmpeg', fps=15, dpi=150)